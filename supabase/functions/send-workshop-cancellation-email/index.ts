...
async function sendCancellationEmail(
  ...
  const rowCell = (label: string, value: string, uppercase = false) =>
    `<tr style="border-bottom:1px solid ${EMAIL_ACCENT_COLOR};">
      <td class="bcs-label bcs-row-label" style="padding:10px 14px;color:${EMAIL_LABEL_COLOR};font-size:${EMAIL_SMALL_SIZE};width:55%;font-family:${EMAIL_FONT_STACK};">${label}</td>
