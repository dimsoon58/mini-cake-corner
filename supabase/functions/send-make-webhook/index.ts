...
serve(async (req) => {
  ...
  try {
    ...
    const itemsPayload = orderItems.map((item) => ({
      ...
      candle_colors: (item.candle_colors || []).join(", "),
    ...
    const webhookPayload = {
      ...
      code_postal_livraison: order.delivery_method === "delivery" ? (order.delivery_postal_code || "") : "",
      ville_livraison: order.delivery_method === "delivery" ? (order.delivery_city || "") : "",
      latitude_livraison: order.delivery_method === "delivery" ? (order.delivery_latitude ?? "") : "",
      longitude_livraison: order.delivery_method === "delivery" ? (order.delivery_longitude ?? "") : "",
      distance_km_livraison: order.delivery_method === "delivery" ? (order.delivery_distance_km ?? "") : "",
