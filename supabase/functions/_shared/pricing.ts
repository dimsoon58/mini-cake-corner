...
export const CAKE_DESIGNS: Record<string, SizePriceMap> = {
  "normal-without-border": { bento: 0, retro: 2, medium: 0, large: 0, rectangle: 0 },
  "normal-with-border": { bento: 0, retro: 3, medium: 0, large: 0, rectangle: 0 },
  ...
  "roses-please": { bento: 3, retro: 8, medium: 15, large: 20, rectangle: 40 },
  ...
  "custom-drawing": { bento: 8, retro: 10, medium: 10, large: 15 },
  ...
  "gender-reveal": { bento: 5, retro: 7, medium: 10, large: 15, rectangle: 40 },
