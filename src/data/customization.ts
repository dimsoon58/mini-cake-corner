...
export const styles = [
  { id: "normal-without-border", name: "Normal without border", price: { bento: 0, retro: 2, medium: 0, large: 0, rectangle: 0 } as Record<string, number>, image: styleNormalWithoutBorder, secondImage: styleNormalWithoutBorder2 },
  { id: "normal-with-border", name: "Normal with border", price: { bento: 0, retro: 3, medium: 0, large: 0, rectangle: 0 } as Record<string, number>, image: styleNormalWithBorder },
  ...
  { id: "roses-please", name: "Roses Please", price: { bento: 3, retro: 8, medium: 15, large: 20, rectangle: 40 } as Record<string, number>, image: designRosesPlease },
  ...
  { id: "custom-drawing", name: "Custom Drawing", price: { bento: 8, retro: 10, medium: 10, large: 15 } as Record<string, number>, image: designDrawing },
  ...
  { id: "gender-reveal", name: "Gender Reveal", price: { bento: 5, retro: 7, medium: 10, large: 15, rectangle: 40 } as Record<string, number>, image: designGenderReveal },
...
export const candles = [
  ...
  { id: "rainbow", name: "Rainbow", image: candleRainbow, imageClassName: "h-40 w-40 scale-[1.6]", unitPrice: 1, hasPack: true, packSize: 6, packPrice: 5 },
