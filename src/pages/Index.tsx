          ...
          <div ref={discoverRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth pb-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {[
              ...
              >
                ...
                {/* Title + Discover button — bottom left, stacked */}
                <div className="absolute bottom-5 left-5 md:bottom-7 md:left-7 flex flex-col items-start gap-3">
                  <p className="text-foreground uppercase tracking-[0.18em] text-[1rem] md:text-[1.15rem] font-bold leading-snug">
