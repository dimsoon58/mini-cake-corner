    ...
    <Layout>
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          <h1 className="font-sans text-3xl sm:text-4xl md:text-6xl uppercase tracking-[0.105em] text-foreground leading-tight mb-4 font-bold">
        ...
        {hasMore ? (
          <div className="flex justify-center mt-12">
            <Button
              onClick={loadMore}
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-10 py-2.5 text-base font-medium tracking-wide rounded-none"
            >
