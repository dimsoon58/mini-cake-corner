...
const styles = [
  ...
  { id: "rainbow-cake", name: "Rainbow Cake", price: { retro: 15, medium: 20, large: 30 }, image: designRainbowCake },
  { id: "roses-please", name: "Roses Please", price: { bento: 6, retro: 8, medium: 15, large: 20 }, image: designRosesPlease },
  { id: "butterfly-garden", name: "Butterfly Garden", price: { retro: 10, medium: 15, large: 20 }, image: designButterflyGarden },
  { id: "custom-drawing", name: "Custom Drawing", price: { bento: 8, retro: 8, medium: 10, large: 15 }, image: designDrawing },
  { id: "printed-picture", name: "Printed Picture", price: { bento: 15, retro: 15, medium: 15, large: 15 }, image: designPrintedPicture },
  { id: "gold-leaves-style", name: "Gold Leaves", price: { bento: 3, retro: 4, medium: 5, large: 8 }, image: designGoldLeaves },
  ...
  { id: "gender-reveal", name: "Gender Reveal", price: { bento: 5, retro: 5, medium: 10, large: 15 }, image: designGenderReveal },
