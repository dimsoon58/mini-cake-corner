      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-foreground leading-relaxed">
          ...
          <div className="space-y-5">
            <p className="font-sans text-sm uppercase tracking-[0.12em] font-semibold text-foreground text-center">
          ...
          <div className="space-y-0">
            <h2 className="font-sans text-lg uppercase tracking-[0.12em] font-semibold text-foreground mb-4">
