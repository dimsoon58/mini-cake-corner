      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-foreground leading-relaxed">
          ...
          <div className="bg-muted/50 border border-border rounded-none p-6 space-y-3">
            ...
            <p className="text-justify">
              {lang === "fr" ? (<>Les commandes prévues <strong>2 ou 3 jours</strong> après leur passation sont des commandes <strong>express</strong> et font l'objet d'un <strong>supplément de 10 %</strong> (calculé sur les produits, hors frais de livraison). <strong>À partir de 4 jours</strong>, le tarif est normal. Nous vous recommandons de commander quelques jours à l'avance, en particulier pour les week-ends et les périodes de fêtes.</>) : (<>Orders scheduled <strong>2 or 3 days</strong> after they are placed are <strong>express</strong> orders and carry a <strong>10% surcharge</strong> (calculated on the products, excluding delivery fees). <strong>From 4 days onward</strong>, standard pricing applies. We recommend ordering a few days ahead, especially for weekends and holidays.</>)}
            </p>
            <p className="text-justify">
