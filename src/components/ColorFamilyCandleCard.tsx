...
export const ColorFamilyCandleCard = ({
  ...
  return (
    <Card className={cn("flex flex-col overflow-hidden bg-white/60 hover:bg-white/80 transition-all border border-foreground/20 rounded-none", existing && "ring-2 ring-primary")}>
